Project.delete_all
Project.create([
  { address: '昙华林', name: '昙华林有石瑛先生故居，走，去看看', lat: 30.552127, lon: 114.309425, sponsor: 'http://7xleh2.dl1.z0.glb.clouddn.com/sf_logo.png', description: '石瑛先生是孙中山的亲密战友和忠实信徒，是欧洲同盟会支部的创建人、负责人，为推翻帝制、建立民国立下了汗马功劳。石瑛在创建国立武昌大学任校长时，始在武昌区三义村置私人住宅一幢二层小楼。故居是辛亥首义革命前辈在武汉市内难得的一处故宅，对研究和展示辛亥革命历史和武汉名城发展轨迹具有极高的价值。让我们去故居里去找寻那年的痕迹。'},
  ...
  { address: '红楼', name: '拾起1911的那段大历史', lat: 30.542217 , lon: 114.306489， description: '宋庆龄名誉主席为红楼和纪念馆亲笔题写了“武昌起义军政府旧址”和“辛亥革命武昌起义纪念馆”两块匾额, 红楼堂屋有个神秘的东西， 去找找看。'},
